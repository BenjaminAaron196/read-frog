 ...
 *
 * Delta from v104: the learning mode no longer writes a count chip into the
 * page, so `learningMode.display.showDensityHint` is gone. Every other value is
 * untouched; the migration drops the field and leaves the reader's marks alone.
 */
